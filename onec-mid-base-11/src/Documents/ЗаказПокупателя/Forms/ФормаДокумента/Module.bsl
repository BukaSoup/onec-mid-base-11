...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Добавление КонтактноеЛицо 	
	Если Элементы.Найти("ГруппаШапкаПраво")<> Неопределено И Элементы.Найти("КонтактноеЛицо")= Неопределено Тогда 
		КонтактноеЛицо = Элементы.Вставить("КонтактноеЛицо",Тип("ПолеФормы"), Элементы.ГруппаШапкаПраво, );
		КонтактноеЛицо.Вид = ВидПоляФормы.ПолеВвода;
		КонтактноеЛицо.ПутьКДанным = "Объект.Д_КонтактноеЛицо";
	КонецЕсли; 
	// КонецДобавление КонтактноеЛицо 	
